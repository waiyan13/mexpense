...
import com.zwylwin.mexpense.databinding.FragmentCloudBinding;
...
public class CloudFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        final TextView textView = binding.textCloud;
        cloudViewModel.getText().observe(getViewLifecycleOwner(), textView::setText);
        return root;
    }
